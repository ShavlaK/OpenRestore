...
class OpenRestoreWin(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("OpenRestore (Windows Edition)")
        ...
        self.logo_label = ctk.CTkLabel(self.nav_frame, text="⚡ OpenRestore", font=ctk.CTkFont(size=20, weight="bold"))
